...
# engine = create_engine("mysql+pymysql://lewis:123456@35.187.155.171/travel?charset=utf8")
...
def get_traveldates(date):
    ...
    if len(days)==1:
        times = {"food":2,"hotel":0,"view":3,"breakfast":0,"afternoon_tea":1}   #拆午餐及晚餐
    else:    #拆午餐及晚餐
        times = {"food":(len(days)-1)*2+1,"hotel":len(days)-1,"view":len(days)*3,"breakfast":len(days)-1,"afternoon_tea":len(days)}
